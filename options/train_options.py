...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_G', type=float, default=0.0004, help='initial learning rate for ADAM optimizer of G')
        parser.add_argument('--lr_D', type=float, default=0.0002, help='initial learning rate for ADAM optimizer of D')
